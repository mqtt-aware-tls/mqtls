...
///// Add for TLS-PS /////
libmosq_EXPORT void mosquitto_role_set(struct mosquitto *mosq, int role);
libmosq_EXPORT void mosquitto_topic_set(struct mosquitto *mosq, 
    unsigned char *topic, int tlen);
//////////////////////////
